...
export class Addresschanges1772128015677 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "address_line1" character varying(200) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "address_line2" character varying(200)`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "city" character varying(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "state" character varying(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "postal_code" character varying(20) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "country" character varying(100) NOT NULL`);
